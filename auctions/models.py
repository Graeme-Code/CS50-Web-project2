...
class Listing(models.Model):
    ...
    def __str__(self):
        return f"ID: {self.id} Title:{self.title} Description:{self.description} Category:{self.category} ImageURL:{self.imageURL} Active:{self.active} Created at:{self.created_at} UserID:{self.user})"
